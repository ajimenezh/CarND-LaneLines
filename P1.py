...
def process_image(image):
	...
	#cv2.imwrite("test_images_output/masked_edges.jpg", cv2.cvtColor(masked_edges, cv2.COLOR_RGB2BGR))
	...
	global idx
	cv2.imwrite("test_images_output/test_" + str(idx) + ".jpg", cv2.cvtColor(result_image, cv2.COLOR_RGB2BGR))
	idx += 1
